...
const LEVEL_META = {
  master: { label: '\u5927\u5e08\u4ee3\u7ec3', color: 'text-amber-300', bg: 'bg-amber-500/15 border-amber-500/30', icon: '\u{1f3c6}' },
  diamond: { label: '\u94bb\u77f3\u4ee3\u7ec3', color: 'text-info', bg: 'bg-info/15 border-info/30', icon: '\u{1f48e}' },
  ...
  <div class="page-shell space-y-6">
    ...
    <template v-else-if="booster">
      ...
      <section class="hero-panel scanline-overlay p-6 sm:p-8 lg:p-10">
        ...
        <div class="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div class="flex items-center gap-5">
            <div class="relative">
              <div class="absolute -inset-1 rounded-[22px] bg-gradient-to-br from-primary-500/50 via-accent-400/30 to-transparent opacity-70 blur-[6px]" aria-hidden="true"></div>
              <div class="relative flex h-20 w-20 items-center justify-center rounded-[22px] border border-primary-300/40 bg-primary-500/10 text-4xl">
            ...
            <div class="space-y-2">
              ...
              <div class="flex flex-wrap items-center gap-3">
                ...
                <span v-if="booster.avg_rating > 0" class="text-sm text-amber-300">
      ...
      <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        ...
        >
          <div class="flex h-11 w-11 items-center justify-center rounded-tile border border-primary-300/35 bg-primary-500/10 text-lg">
            {{ card.icon }}
          </div>
          <div>
      ...
      <section class="surface-card p-6 sm:p-8">
        ...
        <div v-else class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <article
            ...
            :key="svc.id"
            class="stat-card cursor-pointer transition-all duration-200 hover:-translate-y-0.5 hover:border-primary-300/40"
        ...
        <div v-else class="mt-6 space-y-4">
          ...
          >
            <div class="flex items-center justify-between gap-3">
              ...
              <span class="text-amber-300 text-sm">{{ starsDisplay(review.rating) }}</span>
            </div>
